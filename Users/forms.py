...
class CustomUserCreationForm(UserCreationForm):
    ...
    tel_number = forms.IntegerField(label='Telephone number', widget=forms.NumberInput(attrs={'class': 'form-input'}))
    ...
    class Meta:
        ...
        widgets = {
            ...
            'tel_number': forms.NumberInput(attrs={'class': 'form-input'}),
...
class CustomUserChangeForm(UserChangeForm):
    class Meta:
        ...
        widgets = {
            ...
            'email': forms.EmailInput(attrs={'class': 'form-input'}),
            'age': forms.NumberInput(attrs={'class': 'form-input'}),
            'tel_number': forms.Select(attrs={'class': 'form-input'}),
        }
